...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
  <!-- Bootstrap4 Duallistbox -->
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/bs-stepper/css/bs-stepper.min.css">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/dropzone/min/dropzone.min.css">
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
  ...
  <!-- Bootstrap4 Duallistbox -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
  <!-- InputMask -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/moment/moment.min.js"></script>
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/inputmask/jquery.inputmask.min.js"></script>
  <!-- date-range-picker -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/daterangepicker/daterangepicker.js"></script>
  <!-- bootstrap color picker -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"></script>
  <!-- Tempusdominus Bootstrap 4 -->
  ...
  <!-- Bootstrap Switch -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
  <!-- BS-Stepper -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/bs-stepper/js/bs-stepper.min.js"></script>
  <!-- dropzonejs -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/dropzone/min/dropzone.min.js"></script>
  <!-- AdminLTE App -->

...
<body class="hold-transition sidebar-mini">
  ...
  <!-- jquery-validation -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/jquery-validation/jquery.validate.min.js"></script>
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/jquery-validation/additional-methods.min.js"></script>
  <!-- AdminLTE App -->

...
<body class="hold-transition sidebar-mini">
  ...
  <!-- FLOT CHARTS -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/flot/jquery.flot.js"></script>
  <!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins<?php echo base_url('assets/adminlte-dev/') ?>plugins/jquery.flot.resize.js"></script>
  <!-- FLOT PIE PLUGIN - also used to draw donut charts -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins<?php echo base_url('assets/adminlte-dev/') ?>plugins/jquery.flot.pie.js"></script>

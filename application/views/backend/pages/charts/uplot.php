...
<head>
  ...
  <!-- uPlot -->
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/uplot/uPlot.min.css">
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
  ...
  <!-- uPlot -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/uplot/uPlot.iife.min.js"></script>
  <!-- AdminLTE App -->

...
<head>
  ...
  <!-- jsGrid -->
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/jsgrid/jsgrid.min.css">
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/jsgrid/jsgrid-theme.min.css">
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
  ...
  <!-- jsGrid -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/jsgrid/demos/db.js"></script>
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/jsgrid/jsgrid.min.js"></script>
  <!-- AdminLTE App -->

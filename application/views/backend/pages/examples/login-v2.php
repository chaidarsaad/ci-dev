  ...
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        <a href="<?php echo base_url('dashboard/v2') ?>" class="h1"><b>Admin</b>LTE</a>
      </div>
      <div class="card-body">
        <p class="login-box-msg">Sign in to start your session</p>

        <form action="<?php echo base_url('dashboard/v3') ?>" method="post">
        ...
        <p class="mb-1">
          <a href="<?php echo base_url('extras/forgotpasswordv1') ?>">I forgot my password</a>
        </p>
        <p class="mb-0">
          <a href="<?php echo base_url('extras/registerv1') ?>" class="text-center">Register a new membership</a>
        </p>
      </div>
      <!-- /.card-body -->
    </div>

...
<head>
  ...
  <!-- pace-progress -->
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/pace-progress/themes/black/pace-theme-flat-top.css">
  <!-- adminlte-->
...
<body class="hold-transition sidebar-mini pace-primary">
  ...
  <!-- pace-progress -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/pace-progress/pace.min.js"></script>
  <!-- AdminLTE App -->

...
<body class="hold-transition sidebar-mini">
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-striped table-valign-middle">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="<?php echo base_url('assets/adminlte-dev/') ?>dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2">
                                                    Some Product
                                                </td>
                                                <td>$13 USD</td>
                                                <td>
    ...
    <script src="<?php echo base_url('assets/adminlte-dev/') ?>dist/js/pages/dashboard3.js"></script>
</body>

...
<head>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/fullcalendar/main.css">
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
  ...
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/fullcalendar/main.js"></script>

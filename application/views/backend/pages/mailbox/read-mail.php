    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-3">
              <a href="<?php echo base_url('mailbox/inbox') ?>" class="btn btn-primary btn-block mb-3">Back to Inbox</a>
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-footer bg-white">
                  <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                    ...
                    <li>
                      <span class="mailbox-attachment-icon has-img"><img src="<?php echo base_url('assets/adminlte-dev/') ?>dist/img/photo1.png" alt="Attachment"></span>
                    ...
                    <li>
                      <span class="mailbox-attachment-icon has-img"><img src="<?php echo base_url('assets/adminlte-dev/') ?>dist/img/photo2.png" alt="Attachment"></span>

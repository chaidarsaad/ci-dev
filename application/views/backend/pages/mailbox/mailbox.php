  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-3">
            <a href="<?php echo base_url('mailbox/compose') ?>" class="btn btn-primary btn-block mb-3">Compose</a>
                  ...
                  <table class="table table-hover table-striped">
                    <tbody>
                      <tr>
                        ...
                        <td class="mailbox-name"><a href="<?php echo base_url('mailbox/read') ?>">Alexander Pierce</a></td>

...
<head>
  ...
  <!-- Ekko Lightbox -->
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/ekko-lightbox/ekko-lightbox.css">
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- Ekko Lightbox -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/ekko-lightbox/ekko-lightbox.min.js"></script>
  <!-- overlayScrollbars -->
  ...
  <!-- Filterizr-->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/filterizr/jquery.filterizr.min.js"></script>

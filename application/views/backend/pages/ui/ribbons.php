...
<body class="hold-transition sidebar-mini">
                  ...
                  <div class="row mt-4">
                    <div class="col-sm-4">
                      <div class="position-relative">
                        <img src="<?php echo base_url('assets/adminlte-dev/') ?>dist/img/photo1.png" alt="Photo 1" class="img-fluid">
                        <div class="ribbon-wrapper ribbon-lg">
                          <div class="ribbon bg-success text-lg">
                            Ribbon
                          </div>
                    ...
                    <div class="col-sm-4">
                      <div class="position-relative">
                        <img src="<?php echo base_url('assets/adminlte-dev/') ?>dist/img/photo2.png" alt="Photo 2" class="img-fluid">
                        <div class="ribbon-wrapper ribbon-xl">
                          <div class="ribbon bg-warning text-lg">
                            Ribbon
                          </div>
                    ...
                    <div class="col-sm-4">
                      <div class="position-relative" style="min-height: 180px;">
                        <img src="<?php echo base_url('assets/adminlte-dev/') ?>dist/img/photo3.jpg" alt="Photo 3" class="img-fluid">
                        <div class="ribbon-wrapper ribbon-xl">
                          <div class="ribbon bg-danger text-xl">
                            Ribbon
                          </div>
  ...
  <!-- Ion Slider -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/ion-rangeslider/js/ion.rangeSlider.min.js"></script>
  <!-- Bootstrap slider -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/bootstrap-slider/bootstrap-slider.min.js"></script>

...
<head>
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="<?php echo base_url('assets/adminlte-dev/') ?>plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
  <!-- Toastr -->
...
<body class="hold-transition sidebar-mini">
  ...
  <!-- SweetAlert2 -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/sweetalert2/sweetalert2.min.js"></script>
  <!-- Toastr -->
  <script src="<?php echo base_url('assets/adminlte-dev/') ?>plugins/toastr/toastr.min.js"></script>
  <!-- AdminLTE App -->
    ...
    $(function() {
      ...
      $('.toastsDefaultFullImage').click(function() {
        $(document).Toasts('create', {
          ...
          title: 'Toast Title',
          subtitle: 'Subtitle',
          image: '<?php echo base_url('assets/adminlte-dev/') ?>dist/img/user3-128x128.jpg',

...
// $strVirtualDirectory = 'http://localhost';
$strVirtualDirectory = '';
// $strBaseDirectory = '/promedika';
$strBaseDirectory = '/qc';

$strDatabaseProfiling = false;
$strDatabaseControler = 'PostgreSql';
$strDatabaseServer = '127.0.0.1';
$strDatabasePort = 5432;
$strDatabaseName = 'zephir';
$strDatabaseLoginName = 'postgres';
$strDatabasePassword = 'postgres';
...
switch (__SERVER_INSTANCE__) {
	...
	case 'prod':
		...
		define ('__VIRTUAL_DIRECTORY__', $strVirtualDirectory);
		define ('__APPLICATION_ROOT__',  $strBaseDirectory );
		define ('__APPLICATION__', __APPLICATION_ROOT__.'/');
		...
		define ('__DEVTOOLS_CLI__', __DOCROOT__ . __APPLICATION__ . '/cli');
		...
		define ('__INCLUDES__', __DOCROOT__ .  __APPLICATION__ . '/includes');
		...
		// define ('__DATA_CLASSES__', __INCLUDES__ . '/classes/data_classes');
		// define ('__DATAGEN_CLASSES__', __INCLUDES__ . '/classes/data_classes/generated');
		// define ('__DATA_META_CONTROLS__', __INCLUDES__ . '/classes/data_meta_controls');
		// define ('__DATAGEN_META_CONTROLS__', __INCLUDES__ . '/classes/data_meta_controls/generated');

		define ('__DATA_CLASSES__', __DOCROOT__ .  __APPLICATION__ . '/classes/db');
		define ('__DATAGEN_CLASSES__', __DOCROOT__ .  __APPLICATION__ . '/classes/db/generated');
		...
		define ('__BASE_DIRECTORY__', __DOCROOT__ . __SUBDIRECTORY__);
		...
		define('DB_CONNECTION_1', serialize(array(
			'adapter' => $strDatabaseControler,
			'server' => $strDatabaseServer,
			'port' => $strDatabasePort,
			'database' => $strDatabaseName,
			'username' => $strDatabaseLoginName,
			'password' => $strDatabasePassword,
			'profiling' => $strDatabaseProfiling
		))
		);

<?php
	if (!defined('__PREPEND_INCLUDED__')) {
		 ...
		 */
		if (!file_exists(dirname(__FILE__) . DIRECTORY_SEPARATOR . 'configuration.inc.php')) {
		...
		if (realpath(__FILE__) != realpath(__INCLUDES__ . DIRECTORY_SEPARATOR . 'prepend.inc.php'))
		...
		///////////////////////////
		require(__QCODO_CORE__ . DIRECTORY_SEPARATOR . 'qcodo.inc.php');
